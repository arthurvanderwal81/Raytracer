...
namespace Raytracer
{
    public partial class Form1 : Form
    {
        ...
        // TODO: https://en.wikipedia.org/wiki/Sobel_operator
        ...
        private void AnimationFrameUpdate(int frameNumber, Bitmap frame)
        {
            Invoke(new SetFormTextDelegate(SetFormText), "Raytracer | " + frameNumber);
        ...
        private void openToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                openFileDialog.InitialDirectory = @"C:\Dev\Raytracer\Data";
                ...
                {
                    _raytracerOutput = new Bitmap(openFileDialog.FileName);
                    Invalidate();
                    /*
        ...
        private void renderToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            this.ClientSize = new Size(renderResultWidth, renderResultHeight + menuStrip1.Height + progressBar1.Height);
        ...
        {
            RadialBlurRenderer radialBlurRenderer = new RadialBlurRenderer(_raytracerOutput, 21, 20);
            _raytracerOutput = radialBlurRenderer.Render();
